...
const reviews = [
  {
    ...
    job: "Batman",
    image: Batman,
    text: "The team operates efficiently. Everyone plays their part. Trust isn’t given easily — but they’ve earned it. Still, meetings would be 80% shorter if Barry stopped talking.",
  },
  {
    id: 2,
    name: "Clark Kent",
    job: "Superman",
    image: Superman,
    text: "It’s inspiring to stand beside heroes who remind the world that hope never dies. Working with Batman can be... intense, but his results speak louder than his silence.",
  },
  {
    id: 3,
    name: "Diana Prince",
    job: "Wonder Woman",
    image: WonderWoman,
    text: "Every battle tests our courage, every victory strengthens our unity. The League is more than a team — it’s a family forged through truth and honor. Though, some men here could learn manners from the Amazons.",
  },
  {
    id: 4,
    name: "Barry Allen",
    job: "The Flash",
    image: Flash,
    text: "Fast missions, faster teamwork! Love these guys — even if Batman acts allergic to jokes. Honestly, I just wish our snack breaks were longer than our fights.",
  },
  {
    id: 5,
    name: "Arthur Curry",
    job: "Aquaman",
    image: Aquaman,
    text: "Land, sea, or sky — doesn’t matter. The League gets things done. Just wish meetings weren’t always on dry land... ever tried wearing armor in air conditioning?",
  },
];
